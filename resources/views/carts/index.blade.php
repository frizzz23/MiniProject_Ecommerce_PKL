                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="editModalLabel{{ $cart->id }}">Edit Produk di
                                                Keranjang</h5>
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('carts.update', $cart->id) }}" method="POST">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div
                                                        class="flex gap-3 col-md-5 justify-content-between align-items-center">
                                                        <button type="button"
                ...
                <div class="modal-body">
                    <form action="{{ route('carts.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="flex gap-3 col-md-5 justify-content-between align-items-center">
                                <button type="button" onclick="kurang('jumlah')" class="btn btn-sm btn-danger">-</button>
                                <input type="number" class="form-control" name="quantity" id="jumlah"required
                                    value="0">
