      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{route('product-orders.index')}}"aria-expanded="false">
                <span>
                  <i class="ti ti-file-description"></i>
                </span>
                <span class="hide-menu">Product Order</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{route('carts.index')}}"aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{route('reviews.index')}}"aria-expanded="false">
                <span>
                  <i class="ti ti-typography"></i>
                </span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{route('addresses.index')}}"aria-expanded="false">
                <span>
                  <i class="ti ti-typography"></i>
                </span>
          ...
          <div class="unlimited-access hide-menu bg-light-primary position-relative mb-7 mt-5 rounded">
            <div class="d-flex">
              ...
              <div class="unlimited-access-img">
                <img src="{{ asset('style/src/assets/images/backgrounds/rocket.png')}}" alt="" class="img-fluid">
              </div>
            </div>
          </div>
        </nav>
            ...
            <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown"
                  aria-expanded="false">
                  <img src="{{ asset('style/src/assets/images/profile/user-1.jpg')}}" alt="" width="35" height="35" class="rounded-circle">
                </a>
