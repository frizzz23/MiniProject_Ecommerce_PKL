...
@section('main')
                                            ...
                                            <form action="{{ route('products.update', $product->id) }}" method="POST"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    @if ($product->images && count($product->images) > 0)
                                                        ...
                                                        @endforeach
                                                    @endif
                                                    <div id="image_edit_products_{{ $product->id }}">

                                                    </div>
                                                    <div class="mb-3">
                                                        <button type="button" class="btn btn-success w-full"
                                                            onclick="addImage('image_edit_products_{{ $product->id }}')">Tambah
                                                            Foto</button>
                                                    </div>
                                                </div>
    ...
    <script>
        ...
        function addImage(element) {
            const image_products = document.getElementById(element);
            const div = `
        <div class="mb-4">
    ...
    `;
            // Menambahkan elemen di akhir elemen image_products
            image_products.insertAdjacentHTML('beforeend', div);
            id++;
        }
