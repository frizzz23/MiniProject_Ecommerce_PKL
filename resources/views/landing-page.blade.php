        ...
        <div class="max-w-7xl mx-auto py-12">
            ...
            <div class="mt-6 text-center">
                <div class="flex items-center justify-center">
                    ...
                    <button class="mx-4 bg-blue-600 text-white py-2 px-6 rounded-full hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
                        See all categories
                    </button>
            ...
            <div class="carousel-item space-x-4">
                ...
                <div class="relative w-full max-w-xs">
                    ...
                    <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        <span class="absolute -right-px -top-px rounded-bl-3xl rounded-tr-4xl bg-rose-600 px-6 py-4 font-medium uppercase tracking-widest text-white z-10">
                            Save 90%
                        </span>
                        <a href="#">
                            <img class="rounded-t-lg object-cover transition duration-500 group-hover:scale-105 mt-7" src="{{ asset('img/img-carousel-promo/laptop.jpg') }}" alt="product image" />
                        ...
                        <div class="px-5 pb-4 mt-10">
                            <a href="#">
                                <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">Laptop Gaming</h5>
                            </a>
                            <div class="flex items-center justify-between">
                                <p class="text-gray-700">
                                    $49.99
                    ...
                    <div class="absolute inset-0 flex items-center justify-center bg-white/70 backdrop-blur-xs rounded-bl-3xl z-20">
                        <button class="bg-blue-600 text-white py-2 px-6 rounded-full hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
                            See More
                        </button>
                    </div>
                </div>
        ...
        <section class="bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
            <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
                <div class="mx-auto max-w-5xl">
                    <h2 class="text-center text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">Informasi E-commerce</h2>
                    <div class="my-8 xl:mb-16 xl:mt-12">
                        <img class="w-full dark:hidden" src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-showcase.svg" alt="Gambar E-commerce" />
                        <img class="hidden w-full dark:block" src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-showcase-dark.svg" alt="Gambar E-commerce" />
                    </div>
                    <div class="mx-auto max-w-2xl space-y-6 text-left">
                        <p class="text-left font-normal text-gray-500 dark:text-gray-400">
                            E-commerce, atau perdagangan elektronik, adalah aktivitas jual beli produk atau layanan secara online melalui platform digital. Dengan e-commerce, pelanggan dapat dengan mudah menemukan dan membeli produk dari kenyamanan rumah mereka.
                        </p>

                        <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                            Sistem e-commerce modern menawarkan fitur canggih seperti pengelolaan inventaris, opsi pembayaran yang beragam, dan pengiriman yang terintegrasi. Ini memungkinkan bisnis untuk menjangkau audiens yang lebih luas dan meningkatkan penjualan mereka secara signifikan.
                        </p>

                        <p class="text-base font-semibold text-gray-900 dark:text-white">Keunggulan Utama E-commerce:</p>
                        <ul class="list-outside list-disc space-y-4 pl-4 text-base font-normal text-gray-500 dark:text-gray-400">
                            ...
                            <li>
                                <span class="font-semibold text-gray-900 dark:text-white">Pilihan Produk Lebih Banyak: </span>
                                Menyediakan akses ke berbagai produk dari berbagai penjual dalam satu platform.
                            </li>
                            <li>
                                <span class="font-semibold text-gray-900 dark:text-white">Metode Pembayaran Aman: </span>
                                Menawarkan opsi pembayaran digital yang aman, termasuk kartu kredit, e-wallet, dan transfer bank.
                            </li>
                            <li>
                                <span class="font-semibold text-gray-900 dark:text-white">Efisiensi Operasional: </span>
                    ...
                    <div class="my-6 md:my-12">
                        <iframe class="h-[260px] md:h-[540px] w-full rounded-lg" src="https://www.youtube.com/embed/KaLxCiilHns" title="Video Pengantar E-commerce" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    </div>
                    <div class="mx-auto mb-6 max-w-3xl space-y-6 text-left md:mb-12">
                        <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                            Dengan platform e-commerce, konektivitas meliputi berbagai fitur seperti integrasi dengan media sosial, alat promosi digital, dan layanan pelanggan yang responsif.
                        </p>

                        <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                            Investasi dalam e-commerce dapat memberikan keuntungan jangka panjang bagi bisnis, baik dalam meningkatkan efisiensi operasional maupun memperluas pasar secara global.
                        </p>
                    </div>
                    <div class="text-left">
