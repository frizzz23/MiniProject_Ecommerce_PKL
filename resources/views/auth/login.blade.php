...
">
        ...
        <div class="absolute top-0 start-80">
            <img src="{{ asset('img/img-auth/6.png') }}" alt="Login Image" class="w-60 md:w-95 animate-pulse hidden md:block">
        </div>
        ...
        <div class="absolute bottom-36 end-72">
            <img src="{{ asset('img/img-auth/5.png') }}" alt="Login Image" class="w-60 md:w-95 animate-pulse hidden md:block">
        </div>
        <div class="absolute bottom-0 end-20">
            <img src="{{ asset('img/img-auth/1.png') }}" alt="Login Image" class="w-60 md:w-95 animate-pulse hidden md:block">
        </div>
