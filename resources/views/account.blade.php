...
<body class="bg-gray-100 text-gray-800 font-sans">
    <section class="py-8 antialiased md:py-8">
        ...
        <div class="max-w-screen-lg px-6 ml-8">
            <!-- Breadcrumbs -->
            ...
            <h2 class="mb-4 text-xl font-semibold text-gray-800 sm:text-2xl md:mb-6">General overview
            </h2>
        ...
        <div class="min-h-screen p-6 flex">
            ...
            <button id="mobileSidebarToggle" class="fixed top-7 left-2 z-50 md:hidden w-full">
            ...
            <!-- Sidebar -->
            <aside id="sidebar"
                class="fixed md:relative top-0 left-0 w-64 md:w-72 h-full md:h-auto transform -translate-x-full md:translate-x-0 bg-white shadow p-4 z-50 md:z-0 transition-transform duration-300 ease-in-out md:sticky md:top-0 h-full">
                ...
                <nav class="space-y-4">
                    ...
                    <a href="{{ route('user.orders.index') }}" class="flex items-center text-gray-600 hover:text-blue-600 space-x-2">
                    ...
                    <a href="{{ route('user.addresses.index') }}" class="flex items-center text-gray-600 hover:text-blue-600 space-x-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            style="fill: rgba(102, 110, 241, 1);">
                            <path
                ...
                <div class="bg-white p-6 rounded-lg mb-10 shadow">
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <div>
                            ...
                            <button class="mt-4 bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-400">Edit your
                                data</button>
                        </div>
                        <div>
