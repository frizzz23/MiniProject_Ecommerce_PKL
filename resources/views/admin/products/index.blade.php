                    ...
                    <div class="mt-3 mb-2">
                        <form action="{{ route('admin.products.index') }}" method="GET">
                            <div class="flex items-center justify-between">
                                <!-- Filter berdasarkan kategori (kiri) -->
                            ...
                            <tbody>
                                @foreach ($products as $product)
                                    <tr>
                                        ...
                                        <td class="border-bottom-0">Rp
                                            {{ number_format($product->price_product, 0, ',', '.') }}</td>
                                                    ...
                                                    <div class="modal-content" style="padding: 20px;">
                                                        ...
                                                        <div class="modal-body"
                                                            ...
                                                            <form
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input type="text" name="name_product"
                                                                                class="form-control" id="name_product"
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            <label for="stock_product"
                                                                                class="form-label">Stok
                                                                                Produk</label>
                                                                            <input type="number" name="stock_product"
                                                                                class="form-control" id="stock_product"
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input type="number" name="price_product"
                                                                                class="form-control" id="price_product"
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="image_product" class="form-label">Gambar
                                                                        Produk</label>
                                                                    <input type="file" name="image_product"
                                                                        class="form-control" id="image_product"
                                                                        accept="image/*">
                                                                    <span
                                                                        class="text-[#25d162] text-sm text-center my-4 block">Biarkan
