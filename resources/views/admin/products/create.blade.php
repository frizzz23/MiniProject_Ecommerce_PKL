                ...
                <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="price_product" class="form-control" placeholder="Harga" value="{{ old('price_product') }}">
                            @error('price_product')
                                <div class="text-danger mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="stock_product" class="form-control" placeholder="Stok" value="{{ old('stock_product') }}">
                            @error('stock_product')
                                <div class="text-danger mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="brand_id" class="form-select">
                                <option value="" disabled {{ old('brand_id') ? '' : 'selected' }}>Pilih Merek</option>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description_product" class="form-control" rows="3" placeholder="Deskripsi Produk">{{ old('description_product') }}</textarea>
